...
import 'package:weekly/model/data_model.dart';
import 'package:weekly/widget/splash_widget.dart';
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Container(
                  child: Padding(
                    ...
                    child: RichText(
                      ...
                      text: TextSpan(
                        text:
                            'Bubbly Waves is the best place for you to find amazing tourism sites in Indonesia. Just press the ',
                        style: TextStyle(
                            fontSize: 16,
                            fontFamily: 'Poppins',
                            color: Colors.black),
                ...
                Text(
                  "We provide various tourist attractions throughout Indonesia",
                ...
                SplashItem('Kuta Beach', 'Bali', Icons.beach_access),
                SplashItem(
                    'Pujon Kidul Village', 'Malang', Icons.holiday_village),
                SplashItem('Maratua Paradise Resort', 'Derawan', Icons.hotel),
                SizedBox(
                  height: 50,
                ),
                Text(
